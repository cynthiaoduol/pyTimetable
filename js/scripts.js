...
$(document).ready(function () {
  $("#next").click(function () {
    if ($("#teachers2").val() === "") {
      ...
      for (var k = 1; k <= numberOfSubjects[0]; k++) {
        $("#numberOfSubjects").append(
          '<div class="form-group" ><label for=subjectName' +
            k +
            '>Name of Subject:</label><input type="text" class="form-control" placeholder="Name of Subject" id="subjectName' +
            k +
            '"</div>'
        );
      }
      ...
      $(".hidden").hide();
      $("#subjects").append(
        "<h3>Please Input the names  of all the " +
          numberOfSubjects[0] +
          " subjects in the respective fields</h3>"
      );
    }
  });
  ...
  $("#submit").click(function () {
    ...
    for (var j = 1; j < numberOfTeachers[0]; j++) {
      $("#append").append(
        '<div class="container" ></div><h3>Class :' +
          (j + 1) +
          "</h3>" +
